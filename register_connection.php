...
$check_sql = "SELECT * FROM farmer_register WHERE email = '$email' OR mobile = '$mobile'";
...
//   move_uploaded_file($_FILES["resume"]["tmp_name"], $target_file);
  ...
  $sql = "INSERT INTO farmer_register (name,category,email, password, mobile,address)
          VALUES ('$name','$category','$email', MD5('$password'),'$mobile','$address')";
